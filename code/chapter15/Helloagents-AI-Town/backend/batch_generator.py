...
class NPCBatchGenerator:
    ...
    def __init__(self):
        ...
        self.preset_dialogues = {
            "morning": {
                "程文": "早上好!今天要继续优化那个多智能体系统的性能。",
                "浮夸": "新的一天开始了,先整理一下今天的会议安排。",
                "小萌": "早!先来杯咖啡提提神,然后开始设计新界面。"
            },
            "noon": {
                "程文": "写了一上午代码,终于把那个bug修复了!",
                "浮夸": "上午的需求评审会很顺利,下午继续推进。",
                "小萌": "这个配色方案看起来不错,再调整一下细节。"
            },
            "afternoon": {
                "程文": "下午继续写代码,这个算法还需要优化一下。",
                "浮夸": "正在准备下周的产品规划会,需求文档快完成了。",
                "小萌": "设计稿基本完成了,等会儿发给大家看看。"
            },
            "evening": {
                "程文": "今天的代码提交完成,明天继续!",
                "浮夸": "今天的工作差不多了,整理一下明天的待办事项。",
                "小萌": "设计工作告一段落,明天再继续优化。"
            }
        }
    ...
    def _build_batch_prompt(self, context: Optional[str] = None) -> str:
        ...
        prompt = f"""请为Datawhale办公室的5个NPC生成当前的对话或行为描述。
...
【示例输出】
{{"程文": "这个bug真是见鬼了,已经调试两小时了...", "浮夸": "嗯,这个功能的优先级需要重新评估一下。", "小萌": "这杯咖啡的拉花真不错,灵感来了!", "大奔": "今天的会议真是太无聊了,我快睡着了。", "小智": "这个算法的复杂度有点高,需要优化一下。"}}
